...
Script for generating hlb-1 aldicarb drug plots after 1 hour exposure
...
IGNORE = [
    'N2_solvent_control_1h',
    'hlb-1_solvent_control_1h',
    '500uM_aldicarb_hlb-1_1h',
    '50uM_aldicarb_hlb-1_1h',
    '5uM_aldicarb_hlb-1_1h',
    '500uM_aldicarb_N2_1h',
    '50uM_aldicarb_N2_1h',
    '5uM_aldicarb_N2_1h',
    'N2_1h',
    'hlb-1_1h',
...
if __name__ == '__main__':
    ...
    meta.analysis.replace({
                           '0uM_no_compound_N2_1h': 'N2',
                           '0uM_no_compound_N2_4h': 'N2_null',
                           '0uM_solvent_control_N2_1h': 'N2_null',
                           '0uM_solvent_control_N2_4h': 'N2_null',
                           '0uM_no_compound_hlb-1_1h': 'hlb-1',
                           '0uM_no_compound_hlb-1_4h': 'hlb-1_null',
    ...
    strain_lut = {'N2': (0.6, 0.6, 0.6),
                  ...
                  '1uM_aldicarb_hlb-1_1h':(5.625403702604810929e-01, 4.930128535855061722e-01, 8.110720492272496251e-01),
                  '1uM_aldicarb_N2_1h':(7.332316564779161050e-01, 5.430012014091432082e-01, 8.331814925220115686e-01),
                  '10uM_aldicarb_hlb-1_1h':(8.578575836301945978e-01, 6.167295569758052265e-01, 8.124207621880670249e-01),
                  '10uM_aldicarb_N2_1h':(9.348790605721730707e-01, 7.141566770453827706e-01, 7.755791415598958238e-01),
                  '100uM_aldicarb_hlb-1_1h':(9.548328907488411454e-01, 8.123776332007711654e-01, 7.581010612365786105e-01),
                  '100uM_aldicarb_N2_1h':(9.429422622250018815e-01, 8.942894451415310808e-01, 7.843740204486435719e-01)
                  }
